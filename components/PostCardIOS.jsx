    ...
    return (
        <div className='bg-white shadow-2xl rounded-lg p-0 lg:p-8 pb-12 mb-8'>
            ...
            <div className="block lg:flex text-center items-center justify-center mb-4 w-full">
                <div className='flex items-center justify-center mb-4 lg:mb0 w-full lg:w-auto mr-8 items-center'>
                    <img  className='h-7 w-7 align-middle rounded-full' alt={post.author.name} src={post.author.photo.url}/>
